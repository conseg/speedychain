...
sleep 1
gnome-terminal -e "bash -c \"python ~/PycharmProjects/speedychain/runner.py  10.58.208.181 9090 gwa; exec bash\""
sleep 1
gnome-terminal -e "bash -c \"python ~/PycharmProjects/speedychain/runner.py 10.58.208.181 9090 gwb; exec bash\""
sleep 1
