...
#            PIDDeve=$!
            ...
            python $mypathDevice $nsIP 9090 gwf dev-a $numDev $numTr $consensus $contexts $txInterval &
            PIDDeva=$!
            python $mypathDevice $nsIP 9090 gwg dev-b $numDev $numTr $consensus $contexts $txInterval &
            PIDDevb=$!
            python $mypathDevice $nsIP 9090 gwh dev-c $numDev $numTr $consensus $contexts $txInterval &
            PIDDevc=$!
            python $mypathDevice $nsIP 9090 gwi dev-d $numDev $numTr $consensus $contexts $txInterval &
            PIDDevd=$!
            python $mypathDevice $nsIP 9090 gwj dev-e $numDev $numTr $consensus $contexts $txInterval &
            PIDDeve=$!
