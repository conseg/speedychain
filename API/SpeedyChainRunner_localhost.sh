...
sleep 1
gnome-terminal -e "bash -c \"python ~/PycharmProjects/speedychain/API/runner.py 127.0.0.1 9090 gwa; exec bash\""
sleep 1
gnome-terminal -e "bash -c \"python ~/PycharmProjects/speedychain/API/runner.py 127.0.0.1 9090 gwb; exec bash\""
sleep 1
gnome-terminal -e "bash -c \"python ~/PycharmProjects/speedychain/API/runner.py 127.0.0.1 9090 gwc; exec bash\""
sleep 1
gnome-terminal -e "bash -c \"python ~/PycharmProjects/speedychain/API/runner.py 127.0.0.1 9090 gwd; exec bash\""
sleep 1
