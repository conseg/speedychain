...
sleep 1
gnome-terminal -e "bash -c \"python ~/PycharmProjects/speedychain/API/runner.py -n 127.0.0.1 -p 9090 -G gwa -C 0001; exec bash\""
sleep 1
gnome-terminal -e "bash -c \"python ~/PycharmProjects/speedychain/API/runner.py -n 127.0.0.1 -p 9090 -G gwb -C 0001; exec bash\""
sleep 1
gnome-terminal -e "bash -c \"python ~/PycharmProjects/speedychain/API/runner.py -n 127.0.0.1 -p 9090 -G gwc -C 0001; exec bash\""
sleep 1
